...
public class MainActivity extends AppCompatActivity implements HotelAdapter.IHotelAdapter {
    ...
    public void doDelete(int pos) {
        ...
        if (isFilltered) mListAll.remove(mListMapFilter.get(itemPos).intValue());
        mAdapter.notifyDataSetChanged();
        ...
        Snackbar.make(findViewById(R.id.fab), hotel.judul + " Terhapus", Snackbar.LENGTH_LONG)
                .setAction("UNDO", new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (isFilltered) mListAll.add(mListMapFilter.get(itemPos), hotel);
                        mAdapter.notifyDataSetChanged();
                    }
                })
                .show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_ADD && resultCode == RESULT_OK) {
            ...
            mList.add(hotel);
            if (isFilltered) mListAll.add(hotel);
            doFilter(mQuery);
            //mAdapter.notifyDataSetChanged();
